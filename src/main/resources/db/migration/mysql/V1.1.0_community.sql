...
CREATE TABLE zigg.comment_creator
(
...
CREATE TABLE zigg.comment_like
(
    ...
    user_user_id       BIGINT                NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (comment_like_id)
);
...
(
    feedback_feedback_id     BIGINT NOT NULL,
    recipients_space_user_id BIGINT NOT NULL
);
...
(
    history_history_id    BIGINT NOT NULL,
...
(
    space_id            BIGINT AUTO_INCREMENT NOT NULL,
    created_at          datetime              NOT NULL,
    updated_at          datetime              NOT NULL,
...
(
    space_space_id       BIGINT NOT NULL,
...
(
    space_user_id BIGINT AUTO_INCREMENT NOT NULL,
    created_at    datetime              NOT NULL,
    updated_at    datetime              NOT NULL,
...
ALTER TABLE zigg.`history`
    ADD CONSTRAINT UKf6vrs0ismyxitgiog0cacrxug UNIQUE (video_key_video_id);

ALTER TABLE zigg.`history`
    ADD CONSTRAINT UKhsmvp8taeyd1u13qdlemp10d8 UNIQUE (video_thumbnail_url_image_id);
...
ALTER TABLE zigg.`history`
    ADD CONSTRAINT FK18i8edaqojq5svbooag6vl35u FOREIGN KEY (video_thumbnail_url_image_id) REFERENCES zigg.image (image_id) ON DELETE NO ACTION;

ALTER TABLE zigg.comment_creator
    ADD CONSTRAINT FK1ft3i2aompnnav7ifygdyvlki FOREIGN KEY (post_post_id) REFERENCES zigg.post (post_id) ON DELETE NO ACTION;

CREATE INDEX FK1ft3i2aompnnav7ifygdyvlki ON zigg.comment_creator (post_post_id);
...
CREATE INDEX FK41csw925clg9jgs7d4punbc9y ON zigg.post_image_contents (post_post_id);
...
ALTER TABLE zigg.comment_like
    ADD CONSTRAINT FK7hhptnlglennr6on2okb8grlo FOREIGN KEY (comment_comment_id) REFERENCES zigg.comment (comment_id) ON DELETE NO ACTION;

CREATE INDEX FK7hhptnlglennr6on2okb8grlo ON zigg.comment_like (comment_comment_id);
...
ALTER TABLE zigg.comment_like
    ADD CONSTRAINT FKaq3odg9n5566nhptf66pp55kx FOREIGN KEY (user_user_id) REFERENCES zigg.user (user_id) ON DELETE NO ACTION;

CREATE INDEX FKaq3odg9n5566nhptf66pp55kx ON zigg.comment_like (user_user_id);
...
ALTER TABLE zigg.comment
    ADD CONSTRAINT FKl8nbwgv77jgcnpgklda5ajghi FOREIGN KEY (post_post_id) REFERENCES zigg.post (post_id) ON DELETE NO ACTION;

CREATE INDEX FKl8nbwgv77jgcnpgklda5ajghi ON zigg.comment (post_post_id);
...
ALTER TABLE zigg.`history`
    ADD CONSTRAINT FKnqex6gk7fy8vkso46lvqpwdvx FOREIGN KEY (video_key_video_id) REFERENCES zigg.video (video_id) ON DELETE NO ACTION;
...
ALTER TABLE zigg.comment
    ADD CONSTRAINT FKphb3uaew0phnn4lljbbd4sxcc FOREIGN KEY (creator) REFERENCES zigg.comment_creator (id) ON DELETE NO ACTION;

CREATE INDEX FKphb3uaew0phnn4lljbbd4sxcc ON zigg.comment (creator);

ALTER TABLE zigg.comment_creator
    ADD CONSTRAINT FKqty0c28mq6u80tst8w6apv409 FOREIGN KEY (user_user_id) REFERENCES zigg.user (user_id) ON DELETE NO ACTION;

CREATE INDEX FKqty0c28mq6u80tst8w6apv409 ON zigg.comment_creator (user_user_id);
